...
"color: rgb(255, 255, 255);")
        ...
        self.lbl_image.setPixmap(QtGui.QPixmap("malina.jpg"))
    ...
    def run(self):
        while self.cap.isOpened():
            frame, time_11, time_12, time_31, time_32, time_4 = skeleton_recogntion_v3.skeleton_recognition(self.cap, time_11, time_12, time_31, time_32, time_4)
